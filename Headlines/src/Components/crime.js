            ...
            <div className="featured-wrap">
              <div className="col-md-4 col-xs-6">
                <div
                  ...
                  style={{ backgroundImage: "url(https://akm-img-a-in.tosshub.com/indiatoday/images/story/202312/crime-022204-16x9.jpg?VersionId=iMYTlhoRY4.1HU4BYNi05glXnpoc_yX5&size=690:388)" }}
                >
                  <div className="post-info">
                    ...
                    <h3 className="fw-6 fz-16">
                      ...
                      अपराध को जड़ से मिटाने के लिए पुलिस और जनता का सहयोग जरूरी, कानून का सख्त पालन करें।
                      </a>
                    </h3>
                  </div>
                </div>
              ...
              <div className="col-md-4 col-xs-6">
                <div
                  className="featured-post"
                  style={{ backgroundImage: "url(https://st3.depositphotos.com/1010613/18294/i/450/depositphotos_182948156-stock-photo-gavel-handcuffs-law-book-wooden.jpg)" }}
                >
                  <div className="post-info">
                    <a  className="cat-name tt-u">
                    Crime
                    ...
                    <h3 className="fw-6 fz-16">
                      <a  className="text-white">
                      अपराध के खिलाफ जागरूकता फैलाएं, मिलकर काम करें ताकि समाज में सुरक्षा और कानून व्यवस्था कायम रहे।
              ...
              <div className="col-md-4 col-xs-12">
                <div className="top-wrap mb-10">
                  <div
                    className="featured-post"
                    style={{
                      backgroundImage: "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7FXwlPnG_fvCUioSId7UsQ2t2sZE6gW9LkXOeNqLsU--pIqi8gJy__gAGG3tq3dEU56M&usqp=CAU)"
                    }}
                  >
                    <div className="post-info">
                      <a  className="cat-name tt-u">
                      ...
                      <h3 className="fw-6 fz-16">
                        <a  className="text-white">
                        अपराधियों के खिलाफ सख्त कदम उठाएं, न्याय के साथ समाज में शांति और सुरक्षा बहाल करें।
                        </a>
                      </h3>
                    </div>
                  </div>
                ...
                <div className="bottom-wrap">
                  <div
                    className="featured-post"
                    style={{
                      backgroundImage: "url(https://img.etimg.com/thumb/width-420,height-315,imgsize-70360,resizemode-75,msid-66788019/news/politics-and-nation/what-crime-stats-dont-say/crime-getty.jpg)"
                    }}
                  >
                    <div className="post-info">
                      <a  className="cat-name tt-u">
                      ...
                      <h3 className="fw-6 fz-16">
                        <a  className="text-white">
                        अपराध पर कड़ी कार्रवाई जरूरी, कानून का पालन करें और समाज को अपराध मुक्त बनाने में सहयोग दें।
                        </a>
                      </h3>
                    </div>
                  </div>
                    ...
                    <div className="col-xs-6 padding-10">
                      <div className="grid-post">
                        ...
                        <div className="post-info padding-15 ptb-20 bd-grey">
                          ...
                          <span className="date">
                            <i className="ti-timer" /> November 16 , 2017
                          </span>
                        </div>
                      </div>
                    </div>
                      ...
                      <table id="wp-calendar">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a
                                href="http://cracktheme.com/codehube/2017/07/08/"
                                aria-label="Posts published on July 8, 2017"
                              >
                                8
                              </a>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <a
                                href="http://cracktheme.com/codehube/2017/07/12/"
                                aria-label="Posts published on July 12, 2017"
                              >
                                12
                              </a>
                            </td>
                            <td>
                              <a
                                href="http://cracktheme.com/codehube/2017/07/13/"
                                aria-label="Posts published on July 13, 2017"
                              >
                                13
                              </a>
                            </td>
