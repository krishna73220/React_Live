                        ...
                        <div className="featured-wrap">
                            <div className="col-md-4 col-xs-6">
                                <div
                                    ...
                                    style={{ backgroundImage: "url(https://t3.ftcdn.net/jpg/02/78/42/76/360_F_278427683_zeS9ihPAO61QhHqdU1fOaPk2UClfgPcW.jpg)" }}
                                >
                            ...
                            <div className="col-md-4 col-xs-6">
                                <div
                                    className="featured-post"
                                    style={{ backgroundImage: "url(https://st3.depositphotos.com/3591429/18305/i/450/depositphotos_183057156-stock-photo-sports-tools-green-grass-concept.jpg)" }}
                                >
                                    <div className="post-info">
                                        <a  className="cat-name tt-u">
                                            Sports
                                        ...
                                        <h3 className="fw-6 fz-16">
                                            <a  className="text-white">
                                                मैं तो आर्थिक अभाव के कारण खेला नहीं सका लेकिन मैं चाहता हूं
                                                हमारे कोशी - सीमांचल के बच्चे खेलें और ओलंपिक तक जाएं :- संजीव
                                                मिश्रा
                                            </a>
                                        </h3>
                                    </div>
                            ...
                            <div className="col-md-4 col-xs-12">
                                <div className="top-wrap mb-10">
                                    <div
                                        className="featured-post"
                                        style={{ backgroundImage: "url(https://img.freepik.com/premium-photo/set-sport-equipment_1302830-973.jpg)" }}
                                    >
                                        <div className="post-info">
                                            <a  className="cat-name tt-u">
                                                Sports
                                            ...
                                            <h3 className="fw-6 fz-16">
                                                <a  className="text-white">
                                                    इसबार भी पनोरमा स्टार सीजन 07 का होगा आयोजन- संजीव मिश्रा
                                                </a>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div className="bottom-wrap">
                                    <div
                                        className="featured-post"
                                        style={{ backgroundImage: "url(https://static.vecteezy.com/system/resources/previews/045/658/844/non_2x/athlete-sport-design-illustration-art-vector.jpg)" }}
                                    >
                                        <div className="post-info">
                                            <a  className="cat-name tt-u">
                                                Sports
                                            ...
                                            <h3 className="fw-6 fz-16">
                                                <a  className="text-white">
                                                    मैं तो आर्थिक अभाव के कारण खेला नहीं सका लेकिन मैं चाहता हूं
                                                    हमारे कोशी - सीमांचल के बच्चे खेलें और ओलंपिक तक जाएं :-
                                                    संजीव मिश्रा
                                                </a>
                                            </h3>
                                        </div>
